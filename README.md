...
```markdown
![Database Structure](images/database-structure.jpeg)
```
...
```bash
python3 <enrollment-script>.py
```

Replace `<enrollment-script>.py` with the actual enrollment script included in the project.
